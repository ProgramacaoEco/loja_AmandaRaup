...
import 'package:loja_libelula/app/cadastro/cadastro_dados_endereço.dart';
import 'package:loja_libelula/app/providers/itens_pedido_list.dart';
import 'package:loja_libelula/app/model/pagador.dart';
...
//variaveis dos valores
  ...
  var urlGetClienteByCNPJ =
      Uri.parse('http://dev.app.pagozap.com.br:3000/api/Clientes/GetByCNPJ');

  var urlFinalizarPagamentoCarta =
      'https://dev.app.pagozap.com.br:3000/api/CobrancaCartaoCreditoZoop/RegistrarCobrancaDiretaCartaoCredito';
...
// ==================================================================
  ...
  enviarValoresCartaoPagoZap(int idPedido) async {
    ...
    var dadosPagador = await carregaValores();
    print(dadosPagador);
    ...
    var urlFinalizarPagamentoCartao = Uri.parse(
        'http://dev.app.pagozap.com.br:3000/api/CobrancaCartaoCreditoZoop/RegistrarCobrancaDiretaCartaoCredito');
  ...
  mudarStatusPedido(int idPedido) async {
    ...
    var status = jsonEncode({"status_pedido": "Pagamento Aprovado"});
...
// ===========================================================================
  ...
  cadastroPedido() async {
    ...
    var valorTotalReplaced = valorTotalPrefs.replaceAll(',', '');
    int amount = int.parse(valorTotalReplaced);
    print('valor total: $valorTotalPrefs');
    ...
    try {
      responsepedido = await http.post(urlCadastroPedido,
          ...
          body: json.encode({
            ...
            "valor": valorTotalPrefs,
            "forma_pagamento": "Cartao de Credito",
            "vezes_pagamento": int.parse(parce[0]),
            "nome_cliente": dadosPagador['nome'],
            "cpf/cnpj": cpfU ?? cnpjU,
            "telefone": dadosPagador['telefone'],
            "uf": dadosPagador['uf'] == 'retirada' ? 'rt' : dadosPagador['uf'],
            "cidade": dadosPagador['cidade'],
            "endereco_entrega": dadosPagador['logradouro'],
            "cep": dadosPagador['cep'],
            "bairro": dadosPagador['bairro'],
            "complemento": dadosPagador['complemento'],
            "data_pedido": null,
            "updated_at": null,
      ...
      if (responsepedido.statusCode == 200 ||
        ...
        guardarIdPedido();
        enviarValoresCartaoPagoZap(id_pedido);
      }
    } catch (erro) {
      print(erro);
    }
